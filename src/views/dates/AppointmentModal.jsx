...
import { X, User, Mail, Phone, Clock, DollarSign, Zap, Calendar } from 'lucide-react';
import { servicesData } from '../../utils/AppointmentUtils';
...
const AppointmentModal = ({ isOpen, onClose, slot, date, serviceName, onConfirm }) => {
    ...
    // Calcular el tiempo de fin para mostrar al cliente
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="relative">
                        ...
                        <input
                            ...
                            required
                            className="w-full bg-dark-surface border border-white/10 text-text-light rounded-xl py-3 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-gold-accent transition"
                        />
                    </div>
                    <div className="relative">
                        ...
                        <input
                            type="email"
                            name="email"
                            placeholder="Email (ej: yo@correo.com)"
